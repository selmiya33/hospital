                                        ...
                                        <div class="card-sigin">
                                            <div class="main-signup-header">
                                                ...
                                                <div class="form-group">
                                                    <label for="exampleFormControlSelect1">{{ trans('Dashboard/login.as') }}</label>
                                                    <select class="form-control" id="sectionChosser">
                                                ...
                                                <div class="loginform" id="user">
                                                    <h5 class="font-weight-semibold mb-4">{{ trans('Dashboard/login.hint') }} {{ trans('Dashboard/login.user') }}
                                                    </h5>
                                                    ...
                                                    <form method="POST" action="{{ route('login.user') }}">
                                                        ...
                                                        <div class="form-group">
                                                            <label>Email</label> <input class="form-control" required
                                                                autofocus placeholder="Enter your email" type="email"
                                                                name="email">
                                                        </div>
                                                        <div class="form-group">
                                                ...
                                                <div class="loginform" id="admin">
                                                    <h5 class="font-weight-semibold mb-4">{{ trans('Dashboard/login.hint') }}  {{ trans('Dashboard/login.admin') }}</h5>
